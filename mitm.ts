...
export default class MITMProxy {
   ...
   */
  public static async Create(cb: Interceptor = nopInterceptor, interceptPaths: string[] = [], quiet: boolean = false, onlyInterceptTextFiles = false, ignoreHosts: string | null = null): Promise<MITMProxy> {
  ...
  private _mitmProcess:any  ;
  private _mitmError:any;
  private _wss:any;
  public cb: Interceptor|Interceptor=function name(params:InterceptedHTTPMessage) {
   ...
   * @param url
   */
  public getFromStash(url: string): StashedItem|undefined {
